...
import { StyleSheet, TextInput, Text, View, Button, Vibration } from 'react-native';
  ...
  render() {
    return (
      <View style={_styles.container}>
        ...
        <If condition={this.props.authFailMessage}><Text>{this.props.authFailMessage}</Text></If>
        ...
        <Button title="login" onPress={this.props.onValidateCredentials} />
      </View>
    );
  }
};
